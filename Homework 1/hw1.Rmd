...
#1:
my_df <- data.frame(
  Name = c("Alice", "Bob", "Charlie", "Denise","Erin", "Frank", "Gisele", "Harry", "Zachary", "Aren", "Mike", "Hannah"),
...
my_func <- function(my_vec){
  if(my_vec<5){return("This element is NOT greater than 5!")}
  if(my_vec>5){return("This element is greater than 5!")}
}
my_func(my_vec[2])
#9:
